...
const HeroDesc = async () => {
    return (
        <div className="flex-1 p-4 rounded-xl border-4 border-purple-600 mx-auto max-w-xl my-2">
            <SectionTitle title="Full Stack Developer" includeBorder={false} id="pageTitle"/>
